...
public interface AssignmentsDao {
    ...
    @Query("SELECT * FROM Assignment WHERE org_id LIKE :orgId AND date LIKE :date")
    List<Assignment> getAssignmentsByDate(String orgId, String date);

    @Query("SELECT * FROM Assignment WHERE org_id LIKE :orgId AND  teacher_id LIKE :teacherId AND date < :date")
    ...
    @Query("SELECT * FROM Assignment WHERE org_id LIKE :orgId AND class_id LIKE :classId")
    ...
    @Query("DELETE FROM Assignment WHERE org_id LIKE :orgId AND class_id LIKE :classId AND date LIKE date")
    int deleteByClassAndDate(String orgId, String classId, String date);

    @Query("DELETE FROM Assignment WHERE org_id LIKE :orgId AND teacher_id LIKE :teacherId AND date LIKE :date")
    int deleteByTeacherAndDate(String orgId, String teacherId, String date);

    @Query("DELETE FROM Assignment WHERE org_id LIKE :orgId AND teacher_id LIKE :teacherId")
    int deleteByTeacher(String orgId, String teacherId);

    @Query("DELETE FROM Assignment WHERE org_id LIKE :orgId")
    int deleteByOrganization(String orgId);

    @Query("DELETE FROM Assignment WHERE class_id LIKE :classId")
